...
cmd=[
    ...
    'CUDA_VISIBLE_DEVICES={0} '+'python main.py --name AC --data_name AC --n_cluster 2 --pretrain 2 --epochs 500 --log_interval 50 --perplexity 3 --batch_size 500 --ratio 1.0 0.0 0.0 0.05 0.005 --alpha 1.0 --sigma 1.0 --vtrace_out 0.001 0.1',
